 ...
 * Класс модели взаимодействия с базой данных
 *  */
class ModelProjects {
    /**
     *
     * Метод возвращает весь список проектов из таблицы базы данных.
     *
     *
     * @return array
     */
    ...
    /**
     *
     * Метод возвращает весь список статусов проектов из таблицы базы данных.
     *
     *
     * @return array
     */
    ...
    /**
     *
     * Метод возвращает весь список платформ проектов из таблицы базы данных.
     *
     *
     * @return array
     */
    ...
    /**
     *
     * Метод добавляет проект и возвращает добавленный проект.
     *
     * @param array        $line массив характеристик проекта.
     *
     * @return array
     */
    ...
    /**
     *
     * Метод возвращает отфильтрованный список платформ проектов из таблицы базы данных.
     *
     * @param int        $platform ID платформы проекта.
     * @param int        $status ID статуса проекта.
     ...
     *
     * @param int        $id ID проекта.
     * @param array      $line Характеристики обновляемого проекта.
     *
     * @return array
     */
    ...
    /**
     *
     * Метод удаляет проект из таблицы базы данных.
     *
     * @param int        $id ID проекта.
     *
     * @return array
